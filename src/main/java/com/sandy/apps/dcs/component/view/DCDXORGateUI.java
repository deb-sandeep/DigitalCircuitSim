...
public class DCDXORGateUI extends DCDGateUI implements Serializable {
    ...
    private DCDXORGate andGate ;

    public DCDXORGateUI(DCDXORGate gate) {
    ...
    public void paint(Graphics2D g) {
        ...
        g.drawArc(tlx - 3, tly + 5, 20, height - 10, -84, 178) ;

        g.drawLine(tlx + 10, tly + 5, tlx + 19, tly + 5) ;
        g.drawLine(tlx + 11, tly + height - 5, tlx + 19, tly + height - 5) ;
