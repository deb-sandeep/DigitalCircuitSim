...
public class DCDTFlipFlopUI extends DCDFlipFlopUI implements Serializable {

    private DCDTFlipFlop tFlipFlop ;

    public DCDTFlipFlopUI(DCDTFlipFlop gate) {
    ...
    protected void populatePortLocations() {
        ...
        // For a TFlipFlop .. there can be no more than 2 Inputs
        // T and CP. Hence we can directly code it here instead
