...
public class DCDRSFlipFlopUI extends DCDFlipFlopUI implements Serializable {

    private DCDRSFlipFlop rsFlipFlop ;

    public DCDRSFlipFlopUI(DCDRSFlipFlop gate) {

        super(gate) ;
        this.rsFlipFlop = gate ;
    }
    ...
    protected void populatePortLocations() {
        ...
        // For a RSFlipFlop .. there can be no more than 3 Inputs
    ...
    public void paint(Graphics2D g) {
        ...
        g.drawString("S", tlx + 11, tly + 18) ;
        g.drawString("CP", tlx + 11, tly + 38) ;
        g.drawString("R", tlx + 11, tly + 58) ;
